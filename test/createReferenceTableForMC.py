...
process.slimmedJetsSmeared = cms.EDProducer('SmearedPATJetProducer',
        ...
        resolutionFile = cms.FileInPath("nano/nanoAOD/data/jer/Summer16_25nsV1_MC_PtResolution_AK4PFchs.txt"), 
        scaleFactorFile = cms.FileInPath("nano/nanoAOD/data/jer/Summer16_25nsV1_MC_SF_AK4PFchs.txt"), 
